...
<div class="wp-block-group alignfull has-primary-gradient-gradient-background has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--4-xl);padding-right:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--4-xl);padding-left:var(--wp--preset--spacing--xl)">
    ...
    <div class="wp-block-columns alignwide are-vertically-aligned-center">
        ...
        <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:66.66%">
            ...
            <h2 class="wp-block-heading has-3-xl-font-size">Ready to Get Started?</h2>
            <!-- /wp:heading -->
            ...
            <p class="has-neutral-100-color has-text-color has-link-color has-lg-font-size" style="margin-top:var(--wp--preset--spacing--sm)">Join thousands of satisfied customers and transform your business today. No credit card required.</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:33.33%">
            ...
            <p class="has-text-align-center has-neutral-100-color has-text-color has-link-color has-sm-font-size" style="margin-top:var(--wp--preset--spacing--sm)">No credit card required</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
    </div>
