...
<div class="wp-block-group alignwide" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--4-xl);padding-bottom:var(--wp--preset--spacing--4-xl)">
    ...
    <div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--2-xl)">
        ...
        <h2 class="wp-block-heading has-text-align-center has-4-xl-font-size"><?php echo esc_html__( 'Latest Articles', 'versana-companion' ); ?></h2>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"var:preset|spacing|sm"}}},"fontSize":"lg"} -->
        <p class="has-text-align-center has-lg-font-size" style="margin-top:var(--wp--preset--spacing--sm)"><?php echo esc_html__( 'Insights, tutorials, and stories from our team', 'versana-companion' ); ?></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-query alignwide">
        <!-- wp:post-template {"style":{"spacing":{"blockGap":"var:preset|spacing|xl"}},"layout":{"type":"grid","minimumColumnWidth":"20rem"}} -->
        ...
        <div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--xl)">
            ...
            <div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/blog" style="border-radius:8px"><?php echo esc_html__( 'View All Posts →', 'versana-companion' ); ?></a></div>
            <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
    </div>
