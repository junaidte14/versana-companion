...
<div class="wp-block-group alignfull has-neutral-200-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--4-xl);padding-right:var(--wp--preset--spacing--md);padding-bottom:var(--wp--preset--spacing--4-xl);padding-left:var(--wp--preset--spacing--md)">
    ...
    <h2 class="wp-block-heading has-text-align-center has-4-xl-font-size">Stay Updated</h2>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"var:preset|spacing|sm","bottom":"var:preset|spacing|xl"}}},"fontSize":"lg"} -->
    <p class="has-text-align-center has-lg-font-size" style="margin-top:var(--wp--preset--spacing--sm);margin-bottom:var(--wp--preset--spacing--xl)">Subscribe to our newsletter for the latest updates, tips, and exclusive content delivered to your inbox.</p>
    <!-- /wp:paragraph -->
    ...
    <div class="wp-block-group has-shadow-md has-neutral-100-background-color has-background" style="border-radius:8px;padding-top:var(--wp--preset--spacing--xl);padding-right:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl);padding-left:var(--wp--preset--spacing--xl)">
        ...
        <p class="has-text-align-center has-md-font-size" style="margin-bottom:var(--wp--preset--spacing--md)"><strong>📧 Join 10,000+ subscribers</strong></p>
        <!-- /wp:paragraph -->

        <!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|lg"}}},"textColor":"neutral-700"} -->
        <p class="has-text-align-center has-neutral-700-color has-text-color" style="margin-bottom:var(--wp--preset--spacing--lg)">Add a newsletter plugin or form here. Popular options include Newsletter, Mailchimp for WordPress, or ConvertKit.</p>
        <!-- /wp:paragraph -->
        ...
        <div class="wp-block-group">
            ...
            <div class="wp-block-button"><a class="wp-block-button__link wp-element-button" style="border-radius:6px">Subscribe</a></div>
            <!-- /wp:button -->
        </div>
        <!-- /wp:group -->

        <!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"var:preset|spacing|md"}}},"textColor":"neutral-700","fontSize":"xs"} -->
        <p class="has-text-align-center has-neutral-700-color has-text-color has-xs-font-size" style="margin-top:var(--wp--preset--spacing--md)">We respect your privacy. Unsubscribe at any time.</p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
</div>
