...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--2-xl);padding-bottom:var(--wp--preset--spacing--xl)">
    ...
    <h2 class="wp-block-heading has-text-align-center has-4-xl-font-size">Our Services</h2>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"align":"center","fontSize":"md"} -->
    <p class="has-text-align-center has-md-font-size">Comprehensive solutions for modern businesses</p>
    <!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
...
<div class="wp-block-group alignwide" style="padding-bottom:var(--wp--preset--spacing--lg)">
    ...
    <div class="wp-block-columns"><!-- wp:column -->
        <div class="wp-block-column"><!-- wp:heading {"level":3} -->
            ...
            <!-- wp:paragraph -->
            <p>Custom websites and web applications built with modern technologies. From simple landing pages to complex
                platforms.</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column"><!-- wp:heading {"level":3} -->
            ...
            <!-- wp:paragraph -->
            <p>Strategic campaigns across channels to reach your audience and drive conversions. SEO, social media,
                content marketing.</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
    ...
    <div class="wp-block-columns" style="margin-top:var(--wp--preset--spacing--xl)"><!-- wp:column -->
        <div class="wp-block-column"><!-- wp:heading {"level":3} -->
            ...
            <!-- wp:paragraph -->
            <p>Expert guidance on strategy, operations, and growth. We help you make informed decisions and achieve your
                goals.</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column"><!-- wp:heading {"level":3} -->
            ...
            <!-- wp:paragraph -->
            <p>Visual identity and brand strategy that makes your business stand out. Logos, guidelines, and marketing
                materials.</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
