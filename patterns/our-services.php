...
/**
 * Title: Our Services
 * Slug: versana/our-services
 * Categories: versana-patterns
 * Keywords: services, 3 columns, features
 * Description: A large section to showcase top 3 services.
 */
?>
...
<div class="wp-block-group alignfull has-neutral-200-background-color has-background"
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column has-neutral-100-background-color has-background"
            style="border-radius:12px;padding-top:var(--wp--preset--spacing--lg);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--lg);padding-left:var(--wp--preset--spacing--lg)">
            <!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"3rem","lineHeight":"1"},"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|md"}}}} -->
            <p class="has-text-align-center"
                style="margin-top:0;margin-bottom:var(--wp--preset--spacing--md);font-size:3rem;line-height:1">
                💻
            </p>
            <!-- /wp:paragraph -->
            ...
            <p class="has-text-align-center has-neutral-700-color has-text-color">
        ...
        <div class="wp-block-column has-neutral-100-background-color has-background"
            ...
            <!-- wp:paragraph {"align":"center","textColor":"neutral-700"} -->
            <p class="has-text-align-center has-neutral-700-color has-text-color">
                Strategic marketing campaigns that drive results and grow your presence
            </p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column has-neutral-100-background-color has-background"
            ...
            <!-- wp:paragraph {"align":"center","textColor":"neutral-700"} -->
            <p class="has-text-align-center has-neutral-700-color has-text-color">
                Expert guidance to help you make informed decisions and achieve goals
            </p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
